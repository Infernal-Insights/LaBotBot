...
default. To expose it remotely, set `DASHBOARD_HOST` to `0.0.0.0` (or another
interface) along with `DASHBOARD_PORT`. Then visit the VM's public IP in your
browser. For secure remote access, consider tunneling the port over SSH instead
